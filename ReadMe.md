Automated testing for DEMO Web, Android and iOS mobile applications for DEMO, Momondo, Hotelscombined on en-US, da-DK and ko-KR Locales

# 1. Installation

Automated testing for DEMO Android & iOS mobile applications should be able to work with Python3
...
- Install DEMO, Momondo, Hotelscombined iOS/Android apps from playstore
- Clone / Download the source code
- Run the `npm install` to install the requirements

## 3 Builds Link

- Follow the [link for DEMO Android app ](https://play.google.com/store/apps/details?id=com.DEMO.android&hl=en&gl=US)
- Follow the [link for DEMO iOS app ](https://apps.apple.com/us/app/DEMO-flights-hotels-cars/id305204535)
...
Execution can be started using following `npm` commands,
    ...
    platform=ios br_lc=DEMO:en_US npm run wdio

For Android

    platform=android br_lc=DEMO:en_US npm run wdio
